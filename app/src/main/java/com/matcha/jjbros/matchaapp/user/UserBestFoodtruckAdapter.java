 ...
 */
public class UserBestFoodtruckAdapter extends BaseAdapter{

        ArrayList<UserBestFoodtuckItem> datas;
        LayoutInflater inflater;

        public UserBestFoodtruckAdapter(LayoutInflater inflater, ArrayList<UserBestFoodtuckItem> datas) {
            ...
            //이번 예제어세는 UserCategoryDrinkDessertActivity.java에서 전달.
    ...
    //ListView에서 이 MemberDataAdapter 객체에게 요청하는 값으로서
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if( convertView==null){
                ...
                convertView= inflater.inflate(R.layout.activity_user_best_foodtruck_item, null);
            }
            ...
            TextView text_name= (TextView)convertView.findViewById(R.id.tv_user_best_foodtruck_name);
            TextView text_category= (TextView)convertView.findViewById(R.id.tv_user_best_foodtruck_category);
            TextView text_rank= (TextView)convertView.findViewById(R.id.tv_user_best_foodtruck_rank);
            ImageView img_flag= (ImageView)convertView.findViewById(R.id.iv_user_best_foodtruck_img);
            ...
            text_rank.setText( datas.get(position).getRank() );

 ...
 */
public class AddPlanActivity3 extends AppCompatActivity implements OnMapReadyCallback{
...
*/
    ...
    public void onMapReady(GoogleMap map) {
        ...
        try{
            startActivityForResult(intentBuilder.build(AddPlanActivity3.this), PLACE_PICKER_REQUEST);
        } catch (Exception e){
            e.printStackTrace();
        }
    }
